...
class TestConfig(BaseTest):
    ...
    def test_slash_independent(self):
        ...
        self.assertIn("ginclude1*", repository.package_filter.include)
        self.assertIn("gexclude1*", repository.package_filter.exclude)
        ...
        self.assertIn("ginclude3*", repository.package_filter.include)
        self.assertIn("gexclude3*", repository.package_filter.exclude)
